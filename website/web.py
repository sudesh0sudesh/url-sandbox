...
SWITCHES_MAPPED = {
    ...
    'Lobo': 'Mozilla/5.0 (compatible; MSIE 6.0; Windows XP 5.1) Lobo/0.98.4',
    ...
    'Sleipnir': 'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0; Trident/4.0; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET4.0C; .NET4.0E; Sleipnir/2.9.9)',
...
class BufferForm(form.Form):
    ...
    __order = ('buffer', 'proxy', 'choices', 'useragents', 'urltimeout', 'analyzertimeout', 'recaptcha', 'submit', 'submitandwait')
